                ...
                <section className="rounded-2xl border border-border bg-card p-6 shadow-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
                      <Lock className="size-3.5" /> Demo only
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex items-start gap-2 rounded-xl border border-destructive/30 bg-destructive/10 p-3 text-sm text-destructive">
                    ...
                    <p>
                      This is a demonstration payment page. Do not enter real
                      payment information.
                    </p>
                  </div>
  ...
  return (
    <label className={`flex flex-col gap-1.5 ${className ?? ''}`}>
      ...
      <input
        ...
        inputMode={inputMode}
        className="h-11 rounded-xl border border-border bg-background px-3.5 text-sm outline-none transition-colors focus:border-primary focus:ring-2 focus:ring-ring/30"
      />
    </label>
  )
}
